...
| [iosxr_l2vpn_xconnect_group_p2p.l2vpn_xconnect_group_p2p](https://registry.terraform.io/providers/CiscoDevNet/iosxr/latest/docs/resources/l2vpn_xconnect_group_p2p) | resource |
